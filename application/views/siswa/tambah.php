        ...
        <div class="col-12">
            <div class="card mx-auto" style="width: 30rem;">
                <div class="card-body">
                    ...
                    <form class="m-5" action="<?php echo base_url('index.php/siswa/action_tambah') ?>" method="post">
                        ...
                        <a style="color: white;"  class="btn btn-info mt-3" href="<?php echo base_url('index.php/siswa') ?>">Data Siswa</a>
                    </form>
                </div>
            </div>
        </div>
